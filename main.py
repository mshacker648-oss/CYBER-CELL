...
# ================== CONFIG ==================
BOT_TOKEN = "8496368408:AAGkRqFUvNzLoYbeEmBQqtW2_JB7eLPPwsI"   # <-- apna bot token
ADMIN_IDS = [8449475923]                # <-- apna Telegram user id (int)

DEFAULT_CREDITS = 2    # first time user = 2 credits
LOOKUP_COST = 1         # har lookup pe 1 credit

# Force channel join
CHANNEL_ID = -1003128132101
CHANNEL_LINK = "https://t.me/blackhat99494"
...
def lookup_number(mobile_number: str) -> str:
    ...
    try:
        ...
        url = f"https://osintx.info/API/krobetahack.php?key=ZYROBR0TH3R&type=mobile&term={num}"
        ...
        if not data:
            return "❗ Is number ke liye koi data nahi mila."
...
def start_cmd(message):
    ...
    text = (
        ...
        "📞 Number Intelligence Panel me swagat hai.\n\n"
...
def callback_handler(call):
    ...
    if data == "number_info":
        ...
        text = (
            ...
            "unko free credits milenge aur aapko +1 credits milenge.\n\n"
            f"{ref_link}"
        )
